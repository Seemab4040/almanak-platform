      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold transition-colors"><Plus size={13} /> New Meeting</button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> Add Item</button>
          </div>
        </div>
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> Add Record</button>
        </div>
        <table className="w-full text-sm">
          <thead><tr className="bg-[#faf8f5] border-b border-[#e8e4dd]">
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Unit</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col" style={{maxHeight:'85vh'}}>
            ...
            <div className="px-6 py-4 border-t border-[#e8e4dd] flex gap-3">
              <button onClick={() => { setViewingCase(null); openEdit(viewingCase); }} className="flex-1 bg-[#1a3a52] text-white py-2.5 rounded-xl font-semibold hover:bg-[#0f2537] transition-all text-sm">Edit Case</button>
              <button onClick={() => { setViewingCase(null); handleDelete(viewingCase.id); }} className="px-4 bg-red-50 text-red-600 border border-red-200 py-2.5 rounded-xl font-semibold hover:bg-red-100 transition-all text-sm">Delete</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => { resetForm(); setShowModal(true); }} className="flex items-center gap-1.5 text-sm bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => openEdit(c)} className="text-xs text-[#c49b66] border border-[#c49b66] px-3 py-1.5 rounded-lg hover:bg-[#f5ede3] font-semibold transition-all">Edit</button>
                      <button onClick={() => handleDelete(c.id)} className="text-xs text-red-500 border border-red-200 px-3 py-1.5 rounded-lg hover:bg-red-50 font-semibold transition-all">Delete</button>
                    </div>
                  </div>
                </div>
              </div>
...
;
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      case 'dashboard': return <Dashboard meetings={meetings} legalCases={legalCases} complianceItems={complianceItems} setActiveSection={setActiveSection} setMeetings={setMeetings} selectedAssociation={selectedAssociation} />;
      case 'meetings': return <Meetings meetings={meetings} setMeetings={setMeetings} selectedAssociation={selectedAssociation} />;
      case 'compliance': return <Compliance complianceItems={complianceItems} setComplianceItems={setComplianceItems} selectedAssociation={selectedAssociation} />;
      case 'financial': return <Financial delinquentUnits={delinquentUnits} setDelinquentUnits={setDelinquentUnits} selectedAssociation={selectedAssociation} />;
      case 'collections': return <CollectionService collectionRecords={collectionRecords} setCollectionRecords={setCollectionRecords} selectedAssociation={selectedAssociation} />;
      case 'legal_advisory': return <LegalService legalCases={legalCases} setLegalCases={setLegalCases} selectedAssociation={selectedAssociation} />;
