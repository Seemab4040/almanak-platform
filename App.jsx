          ...
          <form onSubmit={handleSaveMinutes} className="space-y-3">
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full text-sm border border-slate-300 rounded-lg px-3 py-2 min-h-[60px] focus:outline-none focus:ring-2 focus:ring-[#c49b66]"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full text-sm border border-slate-300 rounded-lg px-3 py-2 min-h-[80px] focus:outline-none focus:ring-2 focus:ring-[#c49b66]"
                required
              />
            </div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full text-sm border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#c49b66]"
              />
            </div>
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            {viewMode !== 'member' && <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> Add Item</button>}
          </div>
        </div>
          ...
          {filteredItems.map(item => (
            <div key={item.id} className="p-4 hover:bg-[#faf8f5] transition-colors flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div><div className="font-medium text-[#0f2537] text-sm">{item.item}</div><div className="text-xs text-[#a8b5c4] mt-0.5">Deadline: {item.deadline}</div></div>
              </div>
