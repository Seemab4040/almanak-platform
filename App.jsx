...
// --- FORM HELPERS ---
const inputCls = "w-full border border-[#d4cfc7] rounded-lg px-3 py-2 text-sm text-[#0f2537] focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all";
const labelCls = "block text-xs font-semibold text-[#a8b5c4] uppercase tracking-wide mb-1";
...
const MetricCard = ({ label, value, subtext, trend, alert }) => (
  <div className={`bg-white rounded-xl p-5 border ${alert ? 'border-red-200 bg-red-50/30' : 'border-[#0f2537]'} shadow-sm transition-all duration-200 hover:shadow-md`}>
        ...
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              {showFilter && (
                <div className="absolute top-10 right-0 w-64 bg-white border border-[#d4cfc7] rounded-xl shadow-xl z-50 p-4">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all transition-colors"><Plus size={13} /> New Meeting</button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowAddModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Unit</button>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Item</button>
          </div>
        </div>
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Record</button>
        </div>
        <table className="w-full text-sm">
          <thead><tr className="bg-[#faf8f5] border-b border-[#e8e4dd]">
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Unit</th>
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> New Case</button>
        </div>
        <div className="divide-y divide-slate-100">
          {legalCases.map(c => (
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden mb-6">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><MessageCircle size={13} /> New Complaint</button>
          </div>
        </div>
        <div className="divide-y divide-slate-100">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <button onClick={() => setShowDocModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Document</button>
        </div>
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowMemberModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Member</button>
        </div>
        <div className="grid grid-cols-3 gap-4">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowMgrModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Manager</button>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowLawyerModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Lawyer</button>
        </div>
        {lawyers.length > 0 ? (
          <div className="space-y-2">
            {lawyers.map(lawyer => (
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowVendorModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Add Vendor</button>
        </div>
        {vendors.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowDocModal(true)} className="flex items-center gap-1 text-xs bg-[#c49b66] text-white px-3 py-1.5 rounded-lg hover:bg-[#b8895a] shadow-md hover:shadow-lg transition-all"><Plus size={13} /> Upload</button>
        </div>
        <div className="space-y-2">
          {documents.map((doc, i) => (
...
;
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      ...
      case 'services': return <Services legalCases={legalCases} setLegalCases={setLegalCases} selectedAssociation={selectedAssociation} />;
