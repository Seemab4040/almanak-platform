    ...
    <div className="animate-fade-in">
        ...
        {managers.length > 0 ? managers.map(mgr => (
          <div key={mgr.id} className="flex items-center justify-between p-4 bg-[#faf8f5] rounded-xl mb-2 relative group">
            <div className="flex items-center gap-4">
              ...
              <div><div className="font-semibold text-[#0f2537]">{mgr.name}</div><div className="text-sm text-[#a8b5c4] font-medium">Contact: {mgr.contact}</div><div className="text-xs text-slate-400">Services: {mgr.services}</div></div>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setShowLawyerModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> Add Lawyer</button>
        </div>
        {lawyers.length > 0 ? (
          <div className="space-y-2">
            {lawyers.map(lawyer => (
