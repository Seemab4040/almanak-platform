          ...
          {showSettings && (
            <div className="absolute top-7 right-0 w-72 bg-white border border-slate-200 rounded-xl shadow-xl z-50">
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg">
                      ...
                      <div className="w-8 h-4.5 bg-emerald-500 rounded-full relative cursor-pointer"><div className="absolute top-0.5 right-0.5 w-3.5 h-3.5 bg-white rounded-full shadow-sm"></div></div>
                    </div>
                    <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg">
                    ...
                    <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-lg">
                      ...
                      <div className="w-8 h-4.5 bg-slate-300 rounded-full relative cursor-pointer"><div className="absolute top-0.5 left-0.5 w-3.5 h-3.5 bg-white rounded-full shadow-sm"></div></div>
                    </div>
                  </div>
                </div>
                <div>
                ...
                <button className="w-full text-xs text-red-500 font-semibold hover:text-red-700 py-2 border-t border-slate-100 mt-2">Log Out</button>
              </div>
            </div>
          )}
        </div>
