      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <div onClick={() => setShowBell(!showBell)} className="relative cursor-pointer">
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center"><span className="text-white text-xs font-bold">3</span></span>
          </div>
          {showBell && (
            <div className="absolute top-7 right-0 w-80 bg-white border border-slate-200 rounded-xl shadow-xl z-50">
              <div className="flex items-center justify-between p-3 border-b border-slate-100">
                ...
                <span className="text-xs text-amber-600 font-semibold cursor-pointer hover:underline">Mark all read</span>
              </div>
              ...
              <div className="p-3 border-t border-slate-100 text-center"><span className="text-xs text-amber-600 font-semibold cursor-pointer hover:underline">View all notifications</span></div>
            </div>
          )}
        </div>
