...
export default function App() {
  ...
  const handleLogin = (email, password) => {
    ...
    if (email && password) {
      setCurrentUser({ email, name: 'Prof. Alex Atanassoff', role: 'Chairman' });
  ...
  const handleSignup = (name, email, password) => {
    // Simple demo signup - in production, this would call your backend
    if (name && email && password) {
      setCurrentUser({ email, name, role: 'Member' });
      setIsAuthenticated(true);
      loadAllData();
      return true;
    }
