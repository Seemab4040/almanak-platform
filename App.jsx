    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          {viewMode !== 'member' && <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> Add Record</button>}
        </div>
        <table className="w-full text-sm">
          <thead><tr className="bg-[#faf8f5] border-b border-[#e8e4dd]">
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Unit</th>
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Owner</th>
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Amount Received</th>
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Settlement</th>
            <th className="text-left p-3 text-xs font-semibold text-[#a8b5c4] uppercase">Date</th>
