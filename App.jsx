...
const Sidebar = ({ activeSection, setActiveSection, darkMode, userAssociations, selectedAssociation, onAssociationChange }) => {
  ...
  return (
    <aside className={`w-64 border-r flex flex-col h-screen shrink-0 transition-colors duration-300 ${darkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-[#d4cfc7]'}`}>
      ...
      <div className={`p-3 border-b transition-colors ${darkMode ? 'border-slate-700' : 'border-[#e8e4dd]'} relative`}>
        <div className={`text-xs uppercase font-semibold tracking-wider px-2 mb-2 ${darkMode ? 'text-[#a8b5c4]' : 'text-[#8094a8]'}`}>ASSOCIATION</div>
        <div onClick={() => setShowAssocDropdown(!showAssocDropdown)} className={`flex items-center gap-2 p-2 rounded-lg cursor-pointer transition-colors ${darkMode ? 'bg-slate-700 hover:bg-slate-600' : 'bg-[#faf8f5] hover:bg-[#ebe7e0]'}`}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className={`text-xs ${darkMode ? 'text-[#8094a8]' : 'text-[#8094a8]'}`}>{selectedAssociation?.total_units || 0} units</div>
          </div>
          <ChevronDown size={14} className={`transition-transform ${showAssocDropdown ? 'rotate-180' : ''} ${darkMode ? 'text-[#8094a8]' : 'text-[#8094a8]'}`} />
        </div>
        {showAssocDropdown && (
          <div className="absolute top-full left-3 right-3 mt-1 bg-white border border-[#d4cfc7] rounded-xl shadow-lg z-40 overflow-hidden max-h-96 overflow-y-auto">
            {/* List all user associations */}
            {userAssociations && userAssociations.length > 0 ? (
              <div className="p-2">
                <div className="text-xs font-bold text-[#a8b5c4] uppercase px-2 py-1">Switch Association</div>
            ...
            {selectedAssociation && (
              <div className="border-t border-[#e8e4dd] p-3 bg-[#faf8f5]">
                <div className="text-xs font-bold text-[#a8b5c4] uppercase mb-2">Current Association Info</div>
                <div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Total Units</span><span className="font-semibold text-[#2d3748]">{selectedAssociation.total_units}</span></div>
                <div className="flex justify-between text-xs mt-1"><span className="text-[#a8b5c4]">Registered Owners</span><span className="font-semibold text-[#2d3748]">{selectedAssociation.registered_owners}</span></div>
                <div className="flex justify-between text-xs mt-1"><span className="text-[#a8b5c4]">Active Since</span><span className="font-semibold text-[#2d3748]">{selectedAssociation.active_since}</span></div>
              </div>
            )}
            
            <div className="p-3 border-t border-[#e8e4dd]">
              <div className="text-xs font-bold text-[#a8b5c4] uppercase mb-2">Quick Links</div>
              ...
              <div className="p-4 space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-[#faf8f5] rounded-lg">
                    ...
                    <div><div className="text-sm font-semibold text-[#0f2537]">{currentUser?.name || 'User'}</div><div className="text-xs text-[#a8b5c4]">{currentUser?.role || 'Member'} — Lagoon Heights</div></div>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex justify-between text-xs p-2"><span className="text-[#a8b5c4]">Name</span><span className="font-semibold text-[#2d3748]">Lagoon Heights</span></div>
                  <div className="flex justify-between text-xs p-2"><span className="text-[#a8b5c4]">Total Units</span><span className="font-semibold text-[#2d3748]">48</span></div>
                  <div className="flex justify-between text-xs p-2"><span className="text-[#a8b5c4]">Law Firm</span><span className="font-semibold text-[#2d3748]">Sahwan Law</span></div>
                </div>
                {!showLogoutConfirm ? (
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-5 mt-6">
        <div className="flex items-center justify-between mb-4"><div className="flex items-center gap-2"><span className="text-lg">🛡️</span><span className="font-semibold text-[#0f2537]">Compliance Tracker</span></div><span className="text-xs text-[#a8b5c4]">{complianceItems.length} items</span></div>
        ...
        {selectedMeeting && (
          <form onSubmit={handleSaveMinutes} className="space-y-3">
            <div className="bg-[#faf8f5] p-3 rounded-lg mb-3">
              ...
              <div className="text-xs text-[#a8b5c4]">{selectedMeeting.date} at {selectedMeeting.time}</div>
            </div>
...
const Financial = ({ delinquentUnits, setDelinquentUnits, selectedAssociation }) => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-4"><div className="flex items-center gap-2 mb-3"><span className="text-lg">💳</span><span className="font-semibold text-[#2d3748] text-sm">Payment Methods</span></div><div className="space-y-2"><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Bank Transfer</span><span className="font-semibold text-[#2d3748]">BD 18,400</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Online Portal</span><span className="font-semibold text-[#2d3748]">BD 8,200</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Cash</span><span className="font-semibold text-[#2d3748]">BD 1,800</span></div></div></div>
        <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-4"><div className="flex items-center gap-2 mb-3"><span className="text-lg">📊</span><span className="font-semibold text-[#2d3748] text-sm">Budget Overview</span></div><div className="space-y-2"><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Maintenance</span><span className="font-semibold text-[#2d3748]">BD 22,000</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Insurance</span><span className="font-semibold text-[#2d3748]">BD 8,500</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Legal & Admin</span><span className="font-semibold text-[#2d3748]">BD 5,200</span></div></div></div>
        <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm p-4"><div className="flex items-center gap-2 mb-3"><span className="text-lg">📈</span><span className="font-semibold text-[#2d3748] text-sm">Reserves</span></div><div className="space-y-2"><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Emergency Fund</span><span className="font-semibold text-emerald-700">BD 45,000</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Sinking Fund</span><span className="font-semibold text-emerald-700">BD 28,000</span></div><div className="flex justify-between text-xs"><span className="text-[#a8b5c4]">Status</span><span className="font-semibold text-emerald-700">Healthy</span></div></div></div>
      </div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#a8b5c4]">Manage collections and settlements</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#a8b5c4]">Active legal cases and actions</p>
            </div>
          </div>
          ...
          {legalCases.slice(0, 3).map(c => (
            <div key={c.id} className="flex items-center justify-between p-3 bg-[#faf8f5] rounded-lg">
              <div>
                ...
                <div className="text-xs text-[#a8b5c4]">{c.description}</div>
              </div>
                  ...
                  {docs.map(doc => (
                    <div key={doc.id} className="flex items-center justify-between p-3 bg-[#faf8f5] rounded-lg hover:bg-[#ebe7e0] transition-colors">
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-[#a8b5c4]">Uploaded: {doc.uploaded_date}</div>
                      </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {boardMembers.map(member => (
            <div key={member.id} className="border border-[#d4cfc7] rounded-xl p-4 hover:shadow-md transition-all relative group">
              ...
              <div className="flex items-center gap-3 mb-3"><div className="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center text-xl shadow-inner">🏢</div><div><div className="font-semibold text-[#0f2537] text-sm">{member.name}</div><div className="text-xs text-[#a8b5c4]">{member.role}</div></div></div>
            ...
            {lawyers.map(lawyer => (
              <div key={lawyer.id} className="flex items-center justify-between p-3 bg-[#faf8f5] rounded-lg hover:bg-[#ebe7e0] transition-colors">
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#a8b5c4]">{lawyer.firm} • {lawyer.specialty}</div>
  ...
  return (
    <>
      {!isAuthenticated ? (
        ...
        <div className={`min-h-screen flex text-[#1a3a52] font-sans transition-colors duration-300 ${darkMode ? 'bg-[#1a3a52]' : 'bg-[#f5f3f0]'}`}>
