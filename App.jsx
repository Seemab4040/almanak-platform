...
const Modal = ({ open, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-auto flex flex-col animate-fade-in" style={{maxHeight: '90vh'}}>
        <div className="flex items-center justify-between p-5 border-b border-[#e8e4dd] shrink-0">
          <h2 className="text-lg font-bold text-[#0f2537]">{title}</h2>
          <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-slate-100 text-slate-400 hover:text-[#1a3a52] transition-colors"><X size={18} /></button>
        </div>
        ...
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              {showFilter && (
                <div className="absolute top-12 right-0 w-72 bg-white border border-[#d4cfc7] rounded-2xl shadow-2xl z-50 p-4">
    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-[#e8e4dd] shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#e8e4dd] flex items-center justify-between">
          ...
          <button onClick={() => setShowModal(true)} className="flex items-center gap-1 text-xs bg-[#1a3a52] text-white px-4 py-2 rounded-lg hover:bg-[#0f2537] shadow-sm hover:shadow-md transition-all font-semibold"><Plus size={13} /> New Case</button>
        </div>
        <div className="divide-y divide-slate-100">
          {legalCases.map(c => (
            <div key={c.id} className="p-4 hover:bg-[#faf8f5] transition-colors">
              ...
              {c.next_action && (
                <div className="mt-2 text-sm"><span className="text-[#a8b5c4]">Last Action:</span> <span className="text-[#2d3748]">{c.last_action || 'N/A'}</span></div>
              )}
              {c.next_action && (
